...
public class TipoUsuariobd {
    ...
    public boolean RegistrarTipoUsuario(TipoUsuario tipoUsuario) {
        ...
        String sql = "INSERT INTO `ejercicio`.`tipo_usuario` (`tipo_usuario_sistema`, `id_persona_sistema`, `contraseña`)"
    ...
    public boolean eliminarTipoUsuario(TipoUsuario tipoUsuario) {
        ...
        String sql = "DELETE FROM `ejercicio`.`tipo_usuario` WHERE (`idtipo_usuario` = '"+tipoUsuario.getIdTipoUsuario()+"');";
        try {
            con = co.getConexion();
            stm = (Statement) con.createStatement();
            stm.execute(sql);
    ...
    public boolean actualizarTipoUsuario(TipoUsuario tipoUsuario){
        ...
        String sql= "UPDATE `ejercicio`.`tipo_usuario` SET "
