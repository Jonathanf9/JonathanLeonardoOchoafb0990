...
public class Inventariodb {
    ...
    public boolean RegistrarInventario(Inventario inventario) {
        ...
        if (inventario.getFecha_caducidad() == null) {
            sql = "INSERT INTO `ejercicio`.`inventario` "
    ...
    public boolean eliminarInvetario(Inventario inventario) {
        ...
        String sql = "DELETE FROM `ejercicio`.`inventario` WHERE (`id_inventario` = '"
    ...
    public boolean editar(Inventario inventario) throws SQLException {
        ...
        String sql = "UPDATE `ejercicio`.`inventario` SET `codigo_pro` = '" + inventario.getCodigo_pro() + "', "
    ...
    public List<Inventario> busquedadInventarioCodigo(String codigo) {
        ...
        String sql = "SELECT * FROM ejercicio.inventario where codigo_pro like \"%" + codigo + "%\"";
